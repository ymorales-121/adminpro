...
export class PerfilComponent implements OnInit {
  ...
  constructor(
    ...
    if(usuarioService.usuario.google === false){
      console.log('falsaaa');
      this.usuario.google = false;
    }else if(usuarioService.usuario.google === true){
      console.log('verdad');
      this.usuario.google = true;
    }else{
      console.log('cualquier chucha');
  ...
  actualizarPerfil() {
    this.usuarioService.actualizarUsuario(this.perfilForm.value).subscribe(
      () => {
        ...
        Swal.fire('Guardado', 'Usuario modificado correctamente', 'success');
      },
      (err) => {
